Feature: Tree Page Features
  ...
  Scenario: User writes Invalid code and clicks Run button on Overview of Trees Try Editor page
  ...
  Scenario: User clicks the Run button on Terminologies page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Terminologies Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Terminologies Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of trees page
  ...
  Scenario: User clicks the Run button on types of trees page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on types of trees Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on types of trees Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Tree Traversals
  ...
  Scenario: User clicks the Run button on types of Tree Traversals page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Tree Traversals Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Tree Traversals Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Traversals Illustration
  ...
  Scenario: User clicks the Run button on types of Traversals Illustration page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Traversals Illustration Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Traversals Illustration Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Binary Trees
  ...
  Scenario: User clicks the Run button on types of Binary Trees page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Binary Trees Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Binary Trees Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Types of Binary Trees
  ...
  Scenario: User clicks the Run button on types of Types of Binary Trees page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Types of Binary Trees Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Types of Binary Trees Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Implementation in Python
  ...
  Scenario: User clicks the Run button on types of Implementation in Python page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Implementation in Python Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Implementation in Python Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Binary Tree Traversals
  ...
  Scenario: User clicks the Run button on types of Binary Tree Traversals page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Binary Tree Traversals Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Binary Tree Traversals Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Implementation of Binary Trees
  ...
  Scenario: User clicks the Run button on types of Implementation of Binary Trees page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Implementation of Binary Trees Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Implementation of Binary Trees Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Applications of Binary trees
  ...
  Scenario: User clicks the Run button on types of Applications of Binary trees page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Applications of Binary trees Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Applications of Binary trees Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Binary Search Trees
  ...
  Scenario: User clicks the Run button on types of Binary Search Trees page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Binary Search Trees Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Binary Search Trees Try Editor page
  ...
  Scenario: Navigate to Try Editor for Tree Data Structure types of Implementation Of BST
  ...
  Scenario: User clicks the Run button on types of Implementation Of BST page without entering any code for Tree
  ...
  Scenario: User writes valid Python code and clicks Run button on Implementation Of BST Try Editor page
  ...
  Scenario: User writes Invalid code and clicks Run button on Implementation Of BST Try Editor page
