...
#
  #Scenario: User writes valid Python code and clicks Run button on Terminologies Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on Types of Trees Page
...
#
  #Scenario: Navigate to Try Editor for Tree Tree Traversals
...
#
  #Scenario: User writes valid Python code and clicks Run button on Tree Traversals Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on Traversals Illustration Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on  Binary Trees Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on  Types of Binary Trees Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on  Implementation in Python Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on  Binary Tree Traversals Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on  Implementation of Binary Trees Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on  Applications of Binary trees Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on  Binary Search Trees Page
...
#
  #Scenario: User writes valid Python code and clicks Run button on  Implementation Of BST Page
