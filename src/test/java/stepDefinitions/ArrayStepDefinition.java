...
public class ArrayStepDefinition {
	...
	public void the_user_is_logged_with_valid_credential_and_the_user_is_on_the_home_page()
	...
	public void the_user_clicks_run_button_with_invalid_code_from_sheetname_and_row_for_arrays_in_python_page(
	...
	public void the_user_is_on_applications_of_array_page() {
		...
		Assert.assertEquals(actualTitle, "Array", "Expected title: 'Applications of Array' but found: " + actualTitle);
	}
