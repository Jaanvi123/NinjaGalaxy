...
import utils.LoggerLoad;
	...
	public class GraphPageObj 
	{
		...
		@FindBy(xpath = "//a[@href='graph-representations']") WebElement GraphRpresentationsLink;
		
		@FindBy(xpath = "//a[@href='/graph/practice']") WebElement GraphPracticeQuestionsLink;
		@FindBy(xpath = "//a[@href='/tryEditor']") WebElement GraphTryHereLink;
		@FindBy(xpath = "//button[text()='Run']") WebElement GraphRunButtonLink;
		...
		public void GraphPageTitle() {
			...
			String expectedUrl = ConfigReader.getProperty("GraphPageUrl");
		...
		public void clickPracticeQuestionsLink() {
			...
			WebElement editorOutputElement = wait.until(ExpectedConditions.visibilityOf(GraphPracticeQuestionsLink));
